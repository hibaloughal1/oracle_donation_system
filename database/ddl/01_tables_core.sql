...
CREATE TABLE Utilisateur (
    ...
    tel_user       VARCHAR2(20),
    adresse_user   VARCHAR2(200),
    password_hash  VARCHAR2(200) NOT NULL,
    statut_user    VARCHAR2(20) DEFAULT 'ACTIVE'
        CONSTRAINT chk_statut_user CHECK (statut_user IN ('ACTIVE', 'SUSPENDED', 'INACTIVE')),
...
CREATE TABLE Role (
    ...
    code_role  VARCHAR2(30) NOT NULL UNIQUE,
    libelle    VARCHAR2(100) NOT NULL
);

-- ============================================================
-- TABLE: User_Role (Association: Utilisateur N-to-M Role)
-- ============================================================
...
CREATE TABLE Action_social (
    ...
    montant_objectif_action NUMBER,
    montant_recu_action     NUMBER DEFAULT 0,
...
CREATE TABLE Besoin (
    ...
    unite_demande      NUMBER NOT NULL
        CONSTRAINT chk_unite_demande CHECK (unite_demande > 0),
    unite_recue        NUMBER DEFAULT 0
...
-- ============================================================
-- TABLE: Audit_Log_Utilisateur (Security & Audit)
-- ============================================================
CREATE TABLE Audit_Log_Utilisateur (
    ...
    CONSTRAINT fk_audit_user FOREIGN KEY (id_user)
        REFERENCES Utilisateur (id_user) ON DELETE SET NULL
);
...
CREATE TABLE Business_Log_Audit (
    ...
    table_name      VARCHAR2(50)   NOT NULL,
        CONSTRAINT chk_table_name CHECK (table_name IN ('Organisation', 'Action_social', 'Besoin', 'Don', 'Payment_Proofs')),    -- e.g. 'ORGANISATION','ACTION_SOCIAL'
    record_pk       NUMBER,    -- primary key value(s) as text
...
CREATE INDEX idx_utilisateur_email ON Utilisateur(email_user);
...
CREATE INDEX idx_audit_user ON Audit_Log_Utilisateur(id_user);
CREATE INDEX idx_audit_user_changer ON Audit_Log_Utilisateur(changed_by);
